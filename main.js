...
class FoodItem {
    ...
    size;
    price;
    constructor(name, flavour, size, price) {
        this.name = name;
    ...
    getorderDetails() {
        return chalk.black.bgGray(`\n\t\tMy Ordered is ${chalk.black.bgGreen(this.name)},\n\t\tSize is ${chalk.black.bgGreen(this.size)},\n\t\tFlavour ${chalk.black.bgGreen(this.flavour)},\n\t\tPrice is ${chalk.black.bgGreen(this.price)}. `);
    }
}
class Pizza extends FoodItem {
    ...
    takeaway;
    quantity;
    constructor(name, flavour, size, price, extracheese, takeaway, quantity) {
    ...
    getorderDetails() {
        return chalk.black.bgCyanBright(`${super.getorderDetails()},\n\t\tExtracheese Available ${chalk.black.bgRedBright(this.extracheese)},\n\t\tTakeaway ${chalk.black.bgRedBright(this.takeaway)},\n\t\tOrdered Quantity is ${chalk.black.bgRedBright(this.quantity)} `);
    }
}
